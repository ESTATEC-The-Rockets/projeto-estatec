...
public class DonoCarroController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<DonoCarro> atualizar(@PathVariable Long id, @RequestBody @Valid DonoCarro donoCarro) {
        DonoCarro atualizado = service.atualizar(id, donoCarro);
