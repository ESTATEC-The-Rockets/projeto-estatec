...
public class Usuario {
	...
	@Pattern(
			regexp = "^[\\p{L}]+( [\\p{L}]+)*$",  message = "O nome do usuário deve conter apenas letras e espaços.") 
	...
	@Pattern(
			regexp = "^[A-Za-z0-9_@#]+$",
			message = "A senha deve conter apenas letras, números, underline, arroba e hashtag.")
	...
	public Usuario(String nome, double rg, double cpf, LocalDate dataNascimento, String email, String senha, String telefone) {
		this.nome = nome;
		this.rg = rg;
		this.cpf = cpf;
